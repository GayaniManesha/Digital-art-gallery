...
import { AwardIcon, UsersIcon, GlobeIcon, PaletteIcon } from 'lucide-react';
export const About = () => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            delay: 0.2
              ...
              <div className="aspect-video rounded-lg overflow-hidden">
                <img src="https://images.unsplash.com/photo-1577083552431-6e5fd01511c3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80" alt="ARTISTRY Gallery" className="w-full h-full object-cover" />
              </div>
      ...
      <section className="py-20 px-6 bg-gray-900">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => <motion.div key={index} className="flex flex-col items-center text-center p-6" initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
...
const stats = [{
  icon: <AwardIcon size={24} className="text-amber-400" />,
  value: '5+',
  label: 'Years of Excellence'
}, {
  icon: <UsersIcon size={24} className="text-amber-400" />,
  value: '500+',
  label: 'Featured Artists'
}, {
  icon: <GlobeIcon size={24} className="text-amber-400" />,
  value: '40+',
  label: 'Countries Represented'
}, {
  icon: <PaletteIcon size={24} className="text-amber-400" />,
  value: '1000+',
